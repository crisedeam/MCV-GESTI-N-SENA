...
<div class='view-container'>
    <div class='breadcrumb'>
        ...
        <a href='?controller=Ficha&action=index' style='color: #39A900; text-decoration: none; font-weight: 700; text-transform: uppercase;'>Registrar Ficha</a>
    </div>
    ...
    <div class='form-container'>
        ...
        <div class='form-main-panel'>
            <form action='?controller=Ficha&action=save' method='POST'>
                <div class='form-grid'>
                    <div class='form-group full-width'>
                        <label for='fich_id'>ID / Identificador</label>
                        <input type='number' id='fich_id' name='fich_id' class='form-control' placeholder='Ej: 1'  >
                    </div>
                    <div class='form-group full-width'>
