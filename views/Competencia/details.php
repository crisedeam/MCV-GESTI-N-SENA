<div class="view-container">
    ...
    <div class="view-header" style="align-items: center;">
        ...
        <div class="header-actions">
            <a href="?controller=Competencia&action=updateshow&id=" class="btn-action edit" title="Editar" style="padding: 10px 16px; background-color: #f3f4f6; color: #374151; font-weight: 600; text-decoration: none; border-radius: 8px; display: flex; align-items: center; gap: 8px;">
                <i class="fa-solid fa-pen-to-square"></i> Editar
            </a>
            <button class="btn-action delete" title="Eliminar Competencia" style="padding: 10px 16px; background-color: #fee2e2; color: #ef4444; font-weight: 600; border-radius: 8px; display: flex; align-items: center; gap: 8px; cursor: pointer; border: none;">
