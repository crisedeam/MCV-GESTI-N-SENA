...
<div class='view-container'>
    <div class='breadcrumb'>
        ...
        <a href='?controller=Intructor&action=index' style='color: #39A900; text-decoration: none; font-weight: 700; text-transform: uppercase;'>Registrar Intructor</a>
    </div>

    <div class='view-header' style='margin-bottom: 0;'>
        <div class='view-title-block'>
            <h1>Registrar Intructor</h1>
    ...
    <div class='form-container'>
        ...
        <div class='form-main-panel'>
            <form action='?controller=Intructor&action=save' method='POST'>
                <div class='form-grid'>
                ...
                <div class='form-actions'>
                    ...
                    <button type='submit' class='btn-success'>
                        <i class='fa-regular fa-floppy-disk'></i> Guardar Intructor
                    </button>
                </div>
            </form>
        </div>
