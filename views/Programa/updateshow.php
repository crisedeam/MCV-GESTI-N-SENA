...
<div class='view-container'>
    <div class='breadcrumb'>
        ...
        <a href='?controller=Programa&action=index' style='color: #39A900; text-decoration: none; font-weight: 700; text-transform: uppercase;'>Actualizar Programa</a>
    </div>
    ...
    <div class='form-container'>
        ...
        <div class='form-main-panel'>
            <form action='?controller=Programa&action=update' method='POST'>
                <div class='form-grid'>
                    <div class='form-group full-width'>
                        <label for='prog_codigo'>ID / Identificador</label>
                        <input type='number' id='prog_codigo' name='prog_codigo' class='form-control' placeholder='Ej: 1' value='1' readonly style='background-color: #f8fafc;'>
                    </div>
                    <div class='form-group full-width'>
                        <label for='prog_denominacion'>Denominación</label>
                        <input type='text' id='prog_denominacion' name='prog_denominacion' class='form-control' value='Ejemplo'>
                    </div>
                    <div class='form-group full-width'>
                ...
                <div class='form-actions'>
                    ...
                    <button type='submit' class='btn-success'>
                        <i class='fa-regular fa-floppy-disk'></i> Actualizar Programa
                    </button>
                </div>
            </form>
        </div>
